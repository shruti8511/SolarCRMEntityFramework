<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MainMaster.Master" AutoEventWireup="true" CodeBehind="reportaccess.aspx.cs" Inherits="SolarCRM.admin.masters.reportaccess" %>
    ...
    <section class="content-header">
       ...
       <%-- <small>Preview</small>--%>
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Report Access </li>
        </ol>
    </section>
            ...
            <div class="col-md-5">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Report Access</h3>
                    </div>
            ...
            <div class="col-md-7">
                <div class="box box-primary">
                    <div class="box-header">
                        <div class="col-md-6">
                            <h3 class="box-title">Manage Report Access</h3>
                        </div>
                        ...
                        <table id="Table1" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <tr>
                                     ...
                                     <td>
                                        Neil Clark</td>
                                    <td>SaleRep Customer Status Report</td>
