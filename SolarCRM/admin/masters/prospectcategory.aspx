<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MainMaster.Master" AutoEventWireup="true" CodeBehind="prospectcategory.aspx.cs" Inherits="SolarCRM.admin.masters.prospectcategory" %>
                    ...
                    <div class="col-md-5">
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">Prospect Categories</h3>
                            </div>
                            <div class="form-horizontal">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Categories  <span class="red">*</span></label>
                                        <div class="col-sm-9">
                                            <asp:HiddenField ID="hdnProspectCatID" runat="server" ClientIDMode="Static" />
                                            <asp:TextBox ID="txtCategories" ClientIDMode="Static" class="form-control" runat="server" placeholder="Categories"></asp:TextBox>
                                            <span>
                                                <asp:RequiredFieldValidator ID="rfvCategories" runat="server" ErrorMessage="* Required" ControlToValidate="txtCategories"
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Categories ABB <span class="red">*</span></label>
                                        <div class="col-sm-9">
                                            <asp:TextBox ID="txtCategoriesABB" ClientIDMode="Static" class="form-control" runat="server" placeholder="Categories ABB"></asp:TextBox>
                                            <span>
                                                <asp:RequiredFieldValidator ID="rfvCategoriesABB" runat="server" ErrorMessage="* Required" ControlToValidate="txtCategoriesABB"
                                                    ValidationGroup="error"></asp:RequiredFieldValidator></span>
                                        </div>
                                    </div>
                    ...
                    <div class="col-md-7">
                        <div class="box box-primary">
                            <div class="box-header">
                                <div class="col-md-6">
                                    <h3 class="box-title">Manage Prospect Categories</h3>
                                </div>
                            ...
                            <div class="box-body table-scrollable1">
                                <asp:Repeater ID="rptProspectCategory" runat="server" OnItemCommand="rptProspectCategory_ItemCommand">
                                    <HeaderTemplate>
                                        <table id="Table1" class="table table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center">Categories ABB</th>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lblRoofType" runat="server" Text='<%#Eval("ProspectCat") %>'></asp:Label>
                                            </td>

                                            <td>
                                                <asp:Label ID="lblVariation" runat="server" Text='<%#Eval("ProspectCatABB") %>'></asp:Label>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkEdit" runat="server" ToolTip="Edit" CommandName="Edit"
                                                        CommandArgument='<%# Eval("ProspectCatID") %>'><i class="fa fa-edit"></i>
                                                    </asp:LinkButton>
                                                </span>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkDelete" runat="server" ToolTip="Delete" CommandName="Delete"
                                                        CommandArgument='<%# Eval("ProspectCatID") %>' OnClientClick="return confirm('Are you Want to Roof Type?')">
