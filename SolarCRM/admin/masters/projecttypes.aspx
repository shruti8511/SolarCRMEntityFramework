<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MainMaster.Master" AutoEventWireup="true" CodeBehind="projecttypes.aspx.cs" Inherits="SolarCRM.admin.masters.projecttypes" %>
                    ...
                    <div class="col-md-5">
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">Project Types</h3>
                            </div>
                            <div class="form-horizontal">
                                <div class="box-body">
                                    ...
                                    <div class="form-group formmargin">
                                        ...
                                        <div class="col-sm-9">
                                            <asp:HiddenField ID="hdnProjectTypeID" runat="server" ClientIDMode="Static" />
                                            <asp:TextBox ID="txtProjectType" ClientIDMode="Static" class="form-control" runat="server" placeholder="Project Type"></asp:TextBox>
                                            <span>
                                                <asp:RequiredFieldValidator ID="rfvProjectType" runat="server" ErrorMessage="* Required" ControlToValidate="txtProjectType"
                    ...
                    <div class="col-md-7">
                        <div class="box box-primary">
                            ...
                            <div class="box-body table-scrollable1">
                                <asp:Repeater ID="rptProjectType" runat="server" OnItemCommand="rptProjectType_ItemCommand">
                                    <HeaderTemplate>
                                        <table id="Table1" class="table table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    <th class="text-center">Active</th>
                                                    <th class="text-center">Project Types</th>
                                            ...
                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkEdit" runat="server" ToolTip="Edit" CommandName="Edit"
                                                        CommandArgument='<%# Eval("ProjectTypeID") %>'><i class="fa fa-edit"></i>
                                                    </asp:LinkButton>
                                                </span>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkDelete" runat="server" ToolTip="Delete" CommandName="Delete"
                                                        CommandArgument='<%# Eval("ProjectTypeID") %>' OnClientClick="return confirm('Are you Want to Remove Project Type?')">
