<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MainMaster.Master" AutoEventWireup="true" CodeBehind="productfaultdetail.aspx.cs" Inherits="SolarCRM.admin.masters.productfaultdetail" %>
                    ...
                    <div class="col-md-5">
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">Product Fault Details</h3>
                            </div>
                            <div class="form-horizontal">
                                <div class="box-body">
                                    ...
                                    <div class="form-group formmargin">
                                        ...
                                        <div class="col-sm-9">
                                            <asp:HiddenField ID="hdnProductFaultDetailsID" runat="server" ClientIDMode="Static" />
                                            <asp:DropDownList ID="ddlProductFaultCategory" runat="server" CssClass="form-control select2" Style="width: 100%;" TabIndex="1"></asp:DropDownList>
                                            <span>
                                                <asp:RequiredFieldValidator ID="rfvProductFaultCategoryID" runat="server" ErrorMessage="* Required" ControlToValidate="ddlProductFaultCategory"
                                                    ValidationGroup="error"></asp:RequiredFieldValidator></span>
                                        </div>
                                    </div>

                                    <div class="form-group formmargin">
                                        <label class="col-sm-3 control-label">Details <span class="red">*</span> </label>
                                        <div class="col-sm-9">
                                            <asp:TextBox ID="txtProductFaultDetails" ClientIDMode="Static" class="form-control" runat="server" placeholder="Details"></asp:TextBox>
                                            <span>
                                                <asp:RequiredFieldValidator ID="rfvProductFaultDetails" runat="server" ErrorMessage="* Required" ControlToValidate="txtProductFaultDetails"
                                                    ValidationGroup="error"></asp:RequiredFieldValidator></span>
                                        </div>
                                    </div>
                    ...
                    <div class="col-md-7">
                        <div class="box box-primary">
                            <div class="box-header">
                                <div class="col-md-6">
                                    <h3 class="box-title">Manage Product Fault Details</h3>
                                </div>
                            ...
                            <div class="box-body table-scrollable1">
                                <asp:Repeater ID="rptProductFaultDetails" runat="server" OnItemCommand="rptProductFaultDetails_ItemCommand">
                                    <HeaderTemplate>
                                        <table id="Table1" class="table table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center">Fault Details</th>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lblProductFaultCategory" runat="server" Text='<%#Eval("ProductFaultCategory") %>'></asp:Label>
                                            </td>


                                            <td>
                                                <asp:Label ID="lblProductFaultDetails" runat="server" Text='<%#Eval("ProductFaultDetails") %>'></asp:Label>
                                            </td>

                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkEdit" runat="server" ToolTip="Edit" CommandName="Edit"
                                                        CommandArgument='<%# Eval("ProductFaultDetailsID") %>'><i class="fa fa-edit"></i>
                                                    </asp:LinkButton>
                                                </span>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkDelete" runat="server" ToolTip="Delete" CommandName="Delete"
                                                        CommandArgument='<%# Eval("ProductFaultDetailsID") %>' OnClientClick="return confirm('Are you Want to Remove Details?')">
