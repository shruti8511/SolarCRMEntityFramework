<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MainMaster.Master" AutoEventWireup="true" CodeBehind="invoicepaymentstatus.aspx.cs" Inherits="SolarCRM.admin.masters.invoicepaymentstatus" %>
                    ...
                    <div class="col-md-5">
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">Invoice Payment Status</h3>
                            </div>
                            <div class="form-horizontal">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Inv Payment Status<span class="red">*</span></label>
                                        <div class="col-sm-9">
                                            <asp:HiddenField ID="hdnInvoicePaymentStatusID" runat="server" ClientIDMode="Static" />
                                            <asp:TextBox ID="txtInvoicePaymentStatus" ClientIDMode="Static" class="form-control" runat="server" placeholder="Inv Payment Status"></asp:TextBox>
                                            <span>
                                                <asp:RequiredFieldValidator ID="rfvInvoicePaymentStatus" runat="server" ErrorMessage="* Required" ControlToValidate="txtInvoicePaymentStatus"
                    ...
                    <div class="col-md-7">
                        <div class="box box-primary">
                            <div class="box-header">
                                <div class="col-md-6">
                                    <h3 class="box-title">Manage Invoice Payment Status</h3>
                                </div>
                            ...
                            <div class="box-body table-scrollable1">
                                <asp:Repeater ID="rptInvoicePaymentStatus" runat="server" OnItemCommand="rptInvoicePaymentStatus_ItemCommand">
                                    <HeaderTemplate>
                                        <table id="Table1" class="table table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    <th class="text-center">Active</th>
                                                    <th class="text-center">Invoice Payment Status</th>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lblInvoicePaymentStatus" runat="server" Text='<%#Eval("InvoicePaymentStatus") %>'></asp:Label>
                                            </td>

                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkEdit" runat="server" ToolTip="Edit" CommandName="Edit"
                                                        CommandArgument='<%# Eval("InvoicePaymentStatusID") %>'><i class="fa fa-edit"></i>
                                                    </asp:LinkButton>
                                                </span>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkDelete" runat="server" ToolTip="Delete" CommandName="Delete"
                                                        CommandArgument='<%# Eval("InvoicePaymentStatusID") %>' OnClientClick="return confirm('Are you Want to Remove Invoice Payment Status?')">
