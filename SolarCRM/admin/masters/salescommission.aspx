<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MainMaster.Master" AutoEventWireup="true" CodeBehind="salescommission.aspx.cs" Inherits="SolarCRM.admin.masters.salescommission" %>
                            ...
                            <div class="form-horizontal">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label">Sales Rep </label>
                                        <div class="col-sm-8">
                                             <asp:HiddenField ID="hdnEmployeesCommissionID" runat="server" ClientIDMode="Static" />
                                            <asp:DropDownList ID="ddlSalesRep" CssClass="form-control select2" Style="width: 100%;" TabIndex="1" runat="server">
                                                <asp:ListItem Text="Manoj Mistry" Value="1" />
                                                <asp:ListItem Text="Pratik Patel" Value="2" />
                                                <asp:ListItem Text="Piyush Limbani" Value="3" />
                                            </asp:DropDownList>
                                            <span>
                                                <asp:RequiredFieldValidator ID="rfvSalesRep" runat="server" ErrorMessage="* Required" ControlToValidate="ddlSalesRep"
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label">Commission <span class="red">*</span> </label>
                                        <div class="col-sm-8">
                                            <asp:TextBox ID="txtEmployeesCommission" ClientIDMode="Static" class="form-control" runat="server" placeholder="Commission"></asp:TextBox>
                                            <span>
                                                <asp:RequiredFieldValidator ID="rfvEmployeesCommission" runat="server" ErrorMessage="* Required" ControlToValidate="txtEmployeesCommission"
                                                    ValidationGroup="error"></asp:RequiredFieldValidator></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label">Comment <span class="red">*</span> </label>
                                        <div class="col-sm-8">
                                            <asp:TextBox ID="txtEmployeesComment" ClientIDMode="Static" class="form-control" runat="server" placeholder="Comment"></asp:TextBox>
                                            <span>
                                                <asp:RequiredFieldValidator ID="rfvEmployeesComment" runat="server" ErrorMessage="* Required" ControlToValidate="txtEmployeesComment"
                                                    ValidationGroup="error"></asp:RequiredFieldValidator></span>
                                        </div>
                                    </div>
                    ...
                    <div class="col-md-7">
                        <div class="box box-primary">
                            <div class="box-header">
                                <div class="col-md-6">
                                    <h3 class="box-title">Manage Sales Commission</h3>
                                </div>
                            ...
                            <div class="box-body table-scrollable1">
                                <asp:Repeater ID="rptEmployeesCommission" runat="server" OnItemCommand="rptEmployeesCommission_ItemCommand">
                                    <HeaderTemplate>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lblEmployeesCommission" runat="server" Text='<%#Eval("EmployeesCommission") %>'></asp:Label>
                                            </td>


                                            <td>
                                                <asp:Label ID="lblEmployeesComment" runat="server" Text='<%#Eval("EmployeesComment") %>'></asp:Label>
                                            </td>

                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkEdit" runat="server" ToolTip="Edit" CommandName="Edit"
                                                        CommandArgument='<%# Eval("EmployeesCommissionID") %>'><i class="fa fa-edit"></i>
                                                    </asp:LinkButton>
                                                </span>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkDelete" runat="server" ToolTip="Delete" CommandName="Delete"
                                                        CommandArgument='<%# Eval("EmployeesCommissionID") %>' OnClientClick="return confirm('Are you Want to Remove Employees Commission?')">
