<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MainMaster.Master" AutoEventWireup="true" CodeBehind="companytype.aspx.cs" Inherits="SolarCRM.admin.masters.companytype" %>
                    ...
                    <div class="col-md-5">
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">Company Type</h3>
                            </div>
                            <div class="form-horizontal">
                                <div class="box-body">
                                    ...
                                    <div class="form-group formmargin">
                                        <label class="col-sm-4 control-label">Company Type <span class="red">*</span></label>
                                        <div class="col-sm-8">
                                            <asp:HiddenField ID="hdnCompanyTypeID" runat="server" ClientIDMode="Static" />
                                            <asp:TextBox ID="txtCompanyType" ClientIDMode="Static" class="form-control" runat="server" placeholder="Company Type"></asp:TextBox>
                                            <span>
                                                <asp:RequiredFieldValidator ID="rfvProjectType" runat="server" ErrorMessage="* Required" ControlToValidate="txtCompanyType"
                    ...
                    <div class="col-md-7">
                        <div class="box box-primary">
                            <div class="box-header">
                                <div class="col-md-6">
                                    <h3 class="box-title">Manage Company Type</h3>
                                </div>
                            ...
                            <div class="box-body table-scrollable1">
                                <asp:Repeater ID="rptCompanyType" runat="server" OnItemCommand="rptCompanyType_ItemCommand">
                                    <HeaderTemplate>
                                            ...
                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkEdit" runat="server" ToolTip="Edit" CommandName="Edit"
                                                        CommandArgument='<%# Eval("CompanyTypeID") %>'><i class="fa fa-edit"></i>
                                                    </asp:LinkButton>
                                                </span>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkDelete" runat="server" ToolTip="Delete" CommandName="Delete"
                                                        CommandArgument='<%# Eval("CompanyTypeID") %>' OnClientClick="return confirm('Are you Want to Remove Company Type?')">
