<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MainMaster.Master" AutoEventWireup="true" CodeBehind="mtcereason.aspx.cs" Inherits="SolarCRM.admin.masters.mtcereason" %>
    ...
    <section class="content-header">
       ...
       <%-- <small>Preview</small>--%>
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Mtce Reasons </li>
        </ol>
    </section>
                    ...
                    <div class="col-md-5">
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">Mtce Reasons</h3>
                            </div>
                            <div class="form-horizontal">
                                <div class="box-body">

                                    <div class="form-group formmargin">
                                        <label class="col-sm-3 control-label">Mtce Reasons <span class="red">*</span></label>
                                        <div class="col-sm-9">
                                            <asp:HiddenField ID="hdnProjectMtceReasonID" runat="server" ClientIDMode="Static" />
                                            <asp:TextBox ID="txtProjectMtceReason" ClientIDMode="Static" class="form-control" runat="server" placeholder="Mtce Reasons"></asp:TextBox>
                                            <span>
                                                <asp:RequiredFieldValidator ID="rfvProjectMtceReason" runat="server" ErrorMessage="* Required" ControlToValidate="txtProjectMtceReason"
                    ...
                    <div class="col-md-7">
                        <div class="box box-primary">
                            <div class="box-header">
                                <div class="col-md-6">
                                    <h3 class="box-title">Manage Mtce Reasons</h3>
                                </div>
                            ...
                            <div class="box-body table-scrollable1">
                                <asp:Repeater ID="rptProjectMtceReason" runat="server" OnItemCommand="rptProjectMtceReason_ItemCommand">
                                    <HeaderTemplate>
                                        ...
                                        <table id="Table1" class="table table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center">Mtce Reasons</th>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lblMtceCompanyType" runat="server" Text='<%#Eval("ProjectMtceReason") %>'></asp:Label>
                                            </td>

                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkEdit" runat="server" ToolTip="Edit" CommandName="Edit"
                                                        CommandArgument='<%# Eval("ProjectMtceReasonID") %>'><i class="fa fa-edit"></i>
                                                    </asp:LinkButton>
                                                </span>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkDelete" runat="server" ToolTip="Delete" CommandName="Delete"
                                                        CommandArgument='<%# Eval("ProjectMtceReasonID") %>' OnClientClick="return confirm('Are you Want to Remove Mtce Reason?')">
