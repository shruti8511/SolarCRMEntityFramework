<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MainMaster.Master" AutoEventWireup="true" CodeBehind="orderingfrom.aspx.cs" Inherits="SolarCRM.admin.masters.orderingfrom" %>
    ...
    <section class="content-header">
       ...
       <%-- <small>Preview</small>--%>
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Ordering From </li>
        </ol>
    </section>
                    ...
                    <div class="col-md-5">
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">Ordering From</h3>
                            </div>
                            <div class="form-horizontal">
                                <div class="box-body">

                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Ordering From<span class="red">*</span></label>
                                        <div class="col-sm-9">
                                            <asp:HiddenField ID="hdnOrderingFromID" runat="server" ClientIDMode="Static" />
                                            <asp:TextBox ID="txtOrderingFrom" ClientIDMode="Static" class="form-control" runat="server" placeholder="Ordering From"></asp:TextBox>
                                            <span>
                                                <asp:RequiredFieldValidator ID="rfvOrderingFrom" runat="server" ErrorMessage="* Required" ControlToValidate="txtOrderingFrom"
                    ...
                    <div class="col-md-7">
                        <div class="box box-primary">
                            <div class="box-header">
                                <div class="col-md-6">
                                    <h3 class="box-title">Manage Ordering From</h3>
                                </div>
                            ...
                            <div class="box-body table-scrollable1">
                                <asp:Repeater ID="rptOrderingFrom" runat="server" OnItemCommand="rptOrderingFrom_ItemCommand">
                                    <HeaderTemplate>
                                        <table id="Table1" class="table table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    <th class="text-center">Active</th>
                                                    <th class="text-center">Ordering From</th>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lblOrderingFrom" runat="server" Text='<%#Eval("OrderingFrom") %>'></asp:Label>
                                            </td>

                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkEdit" runat="server" ToolTip="Edit" CommandName="Edit"
                                                        CommandArgument='<%# Eval("OrderingFromID") %>'><i class="fa fa-edit"></i>
                                                    </asp:LinkButton>
                                                </span>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkDelete" runat="server" ToolTip="Delete" CommandName="Delete"
                                                        CommandArgument='<%# Eval("OrderingFromID") %>' OnClientClick="return confirm('Are you Want to Remove Ordering From?')">
