<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MainMaster.Master" AutoEventWireup="true" CodeBehind="companylocations.aspx.cs" Inherits="SolarCRM.admin.masters.companylocations" %>
                    ...
                    <div class="col-md-5">
                        <div class="box box-primary">
                            ...
                            <div class="form-horizontal">
                                <div class="box-body">
                                    ...
                                    <div class="form-group formmargin">
                                        ...
                                        <div class="col-sm-9">
                                            <asp:HiddenField ID="hdnCompanyLocationID" runat="server" ClientIDMode="Static" />
                                            <asp:TextBox ID="txtCompanyLocation" ClientIDMode="Static" class="form-control" runat="server" TabIndex="1" placeholder="Company Location"></asp:TextBox>
                                            <span>
                                                <asp:RequiredFieldValidator ID="rfvtxtCompanyLocation" runat="server" ErrorMessage="* Required" ControlToValidate="txtCompanyLocation"
                                                    ValidationGroup="CompanyLocation"></asp:RequiredFieldValidator></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group formmargin">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvddlState" runat="server" ErrorMessage="* Required"
                                                ControlToValidate="ddlState" ValidationGroup="CompanyLocation"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                            ...
                            <div class="box-footer">
                                ...
                                <asp:Button ID="btnUpdate" Visible="false" runat="server" CssClass="btn btn-info pull-right" Text="Update" OnClick="btnUpdate_Click" ValidationGroup="CompanyLocation" />
                                <asp:Button ID="btnSave" class="btn btn-info pull-right" runat="server" Text="Save" OnClick="btnSave_Click" ValidationGroup="CompanyLocation" />
                            </div>
                    ...
                    <div class="col-md-7">
                        <div class="box box-primary">
                            <div class="box-header">
                                <div class="col-md-6">
                                    <h3 class="box-title">Company Locations List</h3>
                                </div>
                            ...
                            <div class="box-body table-scrollable1">
                                <asp:Repeater ID="rptCompanyLocation" runat="server" OnItemCommand="rptCompanyLocation_ItemCommand">
                                    <HeaderTemplate>
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lblCompanyLocation" runat="server" Text='<%#Eval("CompanyLocation") %>'></asp:Label>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkEdit" runat="server" ToolTip="Edit" CommandName="Edit"
                                                        CommandArgument='<%# Eval("CompanyLocationID") %>'><i class="fa fa-edit"></i>
                                                    </asp:LinkButton>
                                                </span>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkDelete" runat="server" ToolTip="Delete" CommandName="Delete"
                                                        CommandArgument='<%# Eval("CompanyLocationID") %>' OnClientClick="return confirm('Are you Want to Remove Company Location?')">
