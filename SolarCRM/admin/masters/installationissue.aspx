<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MainMaster.Master" AutoEventWireup="true" CodeBehind="installationissue.aspx.cs" Inherits="SolarCRM.admin.masters.installationissue" %>
                    ...
                    <div class="col-md-5">
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">Installation Issue</h3>
                            </div>
                            <div class="form-horizontal">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Installation Issue <span class="red">*</span></label>
                                        <div class="col-sm-9">
                                            <asp:HiddenField ID="hdnInstallationIssueID" runat="server" ClientIDMode="Static" />
                                            <asp:TextBox ID="txtInstallationIssue" ClientIDMode="Static" class="form-control" runat="server" placeholder="Installation Issue"></asp:TextBox>
                                            <span>
                                                <asp:RequiredFieldValidator ID="rfvInstallationIssue" runat="server" ErrorMessage="* Required" ControlToValidate="txtInstallationIssue"
                    ...
                    <div class="col-md-7">
                        <div class="box box-primary">
                            <div class="box-header">
                                <div class="col-md-6">
                                    <h3 class="box-title">Manage Installation Issue</h3>
                                </div>
                            ...
                            <div class="box-body table-scrollable1">
                                <asp:Repeater ID="rptInstallationIssue" runat="server" OnItemCommand="rptInstallationIssue_ItemCommand">
                                    <HeaderTemplate>
                                        <table id="Table1" class="table table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    <th class="text-center">Active</th>
                                                    <th class="text-center">Installation Issue</th>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lblInstallationIssue" runat="server" Text='<%#Eval("InstallationIssue") %>'></asp:Label>
                                            </td>

                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkEdit" runat="server" ToolTip="Edit" CommandName="Edit"
                                                        CommandArgument='<%# Eval("InstallationIssueID") %>'><i class="fa fa-edit"></i>
                                                    </asp:LinkButton>
                                                </span>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkDelete" runat="server" ToolTip="Delete" CommandName="Delete"
                                                        CommandArgument='<%# Eval("InstallationIssueID") %>' OnClientClick="return confirm('Are you Want to Remove Installation Issue Status?')">
