<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MainMaster.Master" AutoEventWireup="true" CodeBehind="stockcategory.aspx.cs" Inherits="SolarCRM.admin.masters.stockcategory" %>
                            ...
                            <div class="form-horizontal">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Stock Category<span class="red">*</span></label>
                                        <div class="col-sm-9">
                                            <asp:HiddenField ID="hdnStockCategoryID" runat="server" ClientIDMode="Static" />
                                            <asp:TextBox ID="txtStockCategory" ClientIDMode="Static" class="form-control" runat="server" placeholder="Stock Category"></asp:TextBox>
                                            <span>
                                                <asp:RequiredFieldValidator ID="rfvStockCategory" runat="server" ErrorMessage="* Required" ControlToValidate="txtStockCategory"
                    ...
                    <div class="col-md-7">
                        <div class="box box-primary">
                            <div class="box-header">
                                <div class="col-md-6">
                                    <h3 class="box-title">Manage Stock Category</h3>
                                </div>
                            ...
                            <div class="box-body table-scrollable1">
                                <asp:Repeater ID="rptStockCategory" runat="server" OnItemCommand="rptStockCategory_ItemCommand">
                                    <HeaderTemplate>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lblStockCategory" runat="server" Text='<%#Eval("StockCategory") %>'></asp:Label>
                                            </td>

                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkEdit" runat="server" ToolTip="Edit" CommandName="Edit"
                                                        CommandArgument='<%# Eval("StockCategoryID") %>'><i class="fa fa-edit"></i>
                                                    </asp:LinkButton>
                                                </span>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkDelete" runat="server" ToolTip="Delete" CommandName="Delete"
                                                        CommandArgument='<%# Eval("StockCategoryID") %>' OnClientClick="return confirm('Are you Want to Remove Stock Category?')">
