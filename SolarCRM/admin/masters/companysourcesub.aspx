<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MainMaster.Master" AutoEventWireup="true" CodeBehind="companysourcesub.aspx.cs" Inherits="SolarCRM.admin.masters.leadsourcesub" %>
                    ...
                    <div class="col-md-5">
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">Company Source Sub</h3>
                            </div>
                            <div class="form-horizontal">
                                <div class="box-body">

                                    <div class="form-group formmargin">
                                        <label class="col-sm-4 control-label">Company Source <span class="red">*</span> </label>
                                        <div class="col-sm-8">
                                             <asp:HiddenField ID="hdnCustSourceSubID" runat="server" ClientIDMode="Static" />
                                            <asp:DropDownList ID="ddlCompanySource" runat="server" CssClass="form-control select2" Style="width: 100%;" TabIndex="1"></asp:DropDownList>
                                            <span>
                                                <asp:RequiredFieldValidator ID="rfvCompanySource" runat="server" ErrorMessage="* Required" ControlToValidate="ddlCompanySource"
                                                    ValidationGroup="error"></asp:RequiredFieldValidator></span>
                                        </div>
                                    </div>

                                    <div class="form-group formmargin">
                                        <label class="col-sm-4 control-label">Company Source Sub <span class="red">*</span> </label>
                                        <div class="col-sm-8">
                                            <asp:TextBox ID="txtCompanySourceSub" ClientIDMode="Static" class="form-control" runat="server" placeholder="Cust Source Sub"></asp:TextBox>
                                            <span>
                                                <asp:RequiredFieldValidator ID="rfvCustSourceSub" runat="server" ErrorMessage="* Required" ControlToValidate="txtCompanySourceSub"
                                                    ValidationGroup="error"></asp:RequiredFieldValidator></span>
                                        </div>
                                    </div>
                    ...
                    <div class="col-md-7">
                        <div class="box box-primary">
                            <div class="box-header">
                                <div class="col-md-6">
                                    <h3 class="box-title">Manage Company Source Sub</h3>
                                </div>
                            ...
                            <div class="box-body table-scrollable1">
                                <asp:Repeater ID="rptCompanySourceSub" runat="server" OnItemCommand="rptCompanySourceSub_ItemCommand">
                                    <HeaderTemplate>
                                        <table id="Table1" class="table table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center">Company Source Sub	</th>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            <td class="text-center">
                                             ...
                                             <td>
                                                <asp:Label ID="Label1" runat="server" Text='<%#Eval("CompanySource") %>'></asp:Label>
                                            </td>


                                            <td>
                                                <asp:Label ID="lblCompanySourceSub" runat="server" Text='<%#Eval("CompanySourceSub") %>'></asp:Label>
                                            </td>

                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkEdit" runat="server" ToolTip="Edit" CommandName="Edit"
                                                        CommandArgument='<%# Eval("CompanySourceSubID") %>'><i class="fa fa-edit"></i>
                                                    </asp:LinkButton>
                                                </span>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkDelete" runat="server" ToolTip="Delete" CommandName="Delete"
                                                        CommandArgument='<%# Eval("CompanySourceSubID") %>' OnClientClick="return confirm('Are you Want to Remove Source Sub?')">
