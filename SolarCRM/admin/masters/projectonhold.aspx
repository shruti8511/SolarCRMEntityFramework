<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MainMaster.Master" AutoEventWireup="true" CodeBehind="projectonhold.aspx.cs" Inherits="SolarCRM.admin.masters.projectonhold" %>
    ...
    <section class="content-header">
       ...
       <%-- <small>Preview</small>--%>
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Project On-Hold </li>
        </ol>
    </section>
                    ...
                    <div class="col-md-5">
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">Project On-Hold</h3>
                            </div>
                            <div class="form-horizontal">
                                <div class="box-body">

                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Project On-Hold <span class="red">*</span></label>
                                        <div class="col-sm-9">
                                            <asp:HiddenField ID="hdnProjectOnHoldID" runat="server" ClientIDMode="Static" />
                                            <asp:TextBox ID="txtProjectOnHold" ClientIDMode="Static" class="form-control" runat="server" placeholder="Project On-Hold"></asp:TextBox>
                                            <span>
                                                <asp:RequiredFieldValidator ID="rfvProjectOnHold" runat="server" ErrorMessage="* Required" ControlToValidate="txtProjectOnHold"
                    ...
                    <div class="col-md-7">
                        <div class="box box-primary">
                            <div class="box-header">
                                <div class="col-md-6">
                                    <h3 class="box-title">Manage Project On-Hold</h3>
                                </div>
                            ...
                            <div class="box-body table-scrollable1">
                                <asp:Repeater ID="rptProjectOnHold" runat="server" OnItemCommand="rptProjectOnHold_ItemCommand">
                                    <HeaderTemplate>
                                        <table id="Table1" class="table table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    <th class="text-center">Active</th>
                                                    <th class="text-center">Project On-Hold</th>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lblProjectOnHold" runat="server" Text='<%#Eval("ProjectOnHold") %>'></asp:Label>
                                            </td>

                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkEdit" runat="server" ToolTip="Edit" CommandName="Edit"
                                                        CommandArgument='<%# Eval("ProjectOnHoldID") %>'><i class="fa fa-edit"></i>
                                                    </asp:LinkButton>
                                                </span>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkDelete" runat="server" ToolTip="Delete" CommandName="Delete"
                                                        CommandArgument='<%# Eval("ProjectOnHoldID") %>' OnClientClick="return confirm('Are you Want to Remove Project OnHold Status?')">
