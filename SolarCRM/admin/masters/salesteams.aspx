<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MainMaster.Master" AutoEventWireup="true" CodeBehind="salesteams.aspx.cs" Inherits="SolarCRM.admin.masters.salesteams" %>
                            ...
                            <div class="form-horizontal">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Sales Team <span class="red">*</span></label>
                                        <div class="col-sm-9">
                                            <asp:HiddenField ID="hdnSalesTeamID" runat="server" ClientIDMode="Static" />
                                            <asp:TextBox ID="txtSalesTeam" ClientIDMode="Static" class="form-control" runat="server" placeholder="Sales Team"></asp:TextBox>
                                            <span>
                                                <asp:RequiredFieldValidator ID="rfvSalesTeam" runat="server" ErrorMessage="* Required" ControlToValidate="txtSalesTeam"
                    ...
                    <div class="col-md-7">
                        <div class="box box-primary">
                            <div class="box-header">
                                <div class="col-md-6">
                                    <h3 class="box-title">Manage Sales Team</h3>
                                </div>
                            ...
                            <div class="box-body table-scrollable1">
                                <asp:Repeater ID="rptSalesTeam" runat="server" OnItemCommand="rptSalesTeam_ItemCommand">
                                    <HeaderTemplate>
                                            ...
                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkEdit" runat="server" ToolTip="Edit" CommandName="Edit"
                                                        CommandArgument='<%# Eval("SalesTeamID") %>'><i class="fa fa-edit"></i>
                                                    </asp:LinkButton>
                                                </span>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkDelete" runat="server" ToolTip="Delete" CommandName="Delete"
                                                        CommandArgument='<%# Eval("SalesTeamID") %>' OnClientClick="return confirm('Are you Want to Remove Sales Team?')">
