<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MainMaster.Master" AutoEventWireup="true" CodeBehind="leadcancelreason.aspx.cs" Inherits="SolarCRM.admin.masters.leadcancelreason" %>
                    ...
                    <div class="col-md-5">
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">Lead Cancel Reason</h3>
                            </div>
                            <div class="form-horizontal">
                                <div class="box-body">

                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Lead Cancel Reason </label>

                                        <div class="col-sm-9">
                                            <asp:HiddenField ID="hdnContLeadCancelReasonID" runat="server" ClientIDMode="Static" />
                                            <asp:TextBox ID="txtLeadCancelReason" ClientIDMode="Static" class="form-control" runat="server" placeholder="Lead Cancel Reason"></asp:TextBox>
                                            <span>
                                                <asp:RequiredFieldValidator ID="rfvLeadCancelReason" runat="server" ErrorMessage="* Required" ControlToValidate="txtLeadCancelReason"
                    ...
                    <div class="col-md-7">
                        <div class="box box-primary">
                            ...
                            <div class="box-body table-scrollable1">
                                ...
                                <asp:Repeater ID="rptLeadCancelReason" runat="server" OnItemCommand="rptLeadCancelReason_ItemCommand">
                                    <HeaderTemplate>
                                        <table id="Table1" class="table table-bordered table-hover">
                                            <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="text-center">Lead Cancel Reason</th>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lblContLeadCancelReason" runat="server" Text='<%#Eval("ContLeadCancelReason") %>'></asp:Label>
                                            </td>
                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkEdit" runat="server" ToolTip="Edit" CommandName="Edit"
                                                        CommandArgument='<%# Eval("ContLeadCancelReasonID") %>'><i class="fa fa-edit"></i>
                                                    </asp:LinkButton>
                                                </span>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkDelete" runat="server" ToolTip="Delete" CommandName="Delete"
                                                        CommandArgument='<%# Eval("ContLeadCancelReasonID") %>' OnClientClick="return confirm('Are you Want to Remove Company Source?')">
