<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MainMaster.Master" AutoEventWireup="true" CodeBehind="invsupplier.aspx.cs" Inherits="SolarCRM.admin.masters.invsupplier" %>
                    ...
                    <div class="col-md-5">
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">Inverter Supplier</h3>
                            </div>
                            <div class="form-horizontal">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Inverter Supplier<span class="red">*</span></label>
                                        <div class="col-sm-9">
                                            <asp:HiddenField ID="hdnInverterSupplierID" runat="server" ClientIDMode="Static" />
                                            <asp:TextBox ID="txtInverterSupplier" ClientIDMode="Static" class="form-control" runat="server" placeholder="Inverter Supplier"></asp:TextBox>
                                            <span>
                                                <asp:RequiredFieldValidator ID="rfvInverterSupplier" runat="server" ErrorMessage="* Required" ControlToValidate="txtInverterSupplier"
                    ...
                    <div class="col-md-7">
                        <div class="box box-primary">
                            <div class="box-header">
                                <div class="col-md-6">
                                    <h3 class="box-title">Manage Inverter Supplier</h3>
                                </div>
                            ...
                            <div class="box-body table-scrollable1">
                                <asp:Repeater ID="rptInverterSupplier" runat="server" OnItemCommand="rptInverterSupplier_ItemCommand">
                                    <HeaderTemplate>
                                        <table id="Table1" class="table table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    <th class="text-center">Active</th>
                                                    <th class="text-center">Inverter Supplier</th>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lblInverterSupplier" runat="server" Text='<%#Eval("InverterSupplier") %>'></asp:Label>
                                            </td>

                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkEdit" runat="server" ToolTip="Edit" CommandName="Edit"
                                                        CommandArgument='<%# Eval("InverterSupplierID") %>'><i class="fa fa-edit"></i>
                                                    </asp:LinkButton>
                                                </span>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkDelete" runat="server" ToolTip="Delete" CommandName="Delete"
                                                        CommandArgument='<%# Eval("InverterSupplierID") %>' OnClientClick="return confirm('Are you Want to Remove Inverter Supplier?')">
