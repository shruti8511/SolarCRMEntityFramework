<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MainMaster.Master" AutoEventWireup="true" CodeBehind="mtcereasonsub.aspx.cs" Inherits="SolarCRM.admin.masters.mtcereasonsub" %>
    ...
    <section class="content-header">
       ...
       <%-- <small>Preview</small>--%>
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Mtce Reasons Sub </li>
        </ol>
    </section>
                    ...
                    <div class="col-md-5">
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">Mtce Reasons Sub</h3>
                            </div>
                            <div class="form-horizontal">
                                <div class="box-body">

                                    <div class="form-group formmargin">
                                        <label class="col-sm-3 control-label">Mtce Reasons Sub <span class="red">*</span></label>
                                        <div class="col-sm-9">
                                            <asp:HiddenField ID="hdnProjectMtceReasonSubID" runat="server" ClientIDMode="Static" />
                                            <asp:TextBox ID="txtProjectMtceReasonSub" ClientIDMode="Static" class="form-control" runat="server" placeholder="Mtce Reasons Sub"></asp:TextBox>
                                            <span>
                                                <asp:RequiredFieldValidator ID="rfvProjectMtceReasonSub" runat="server" ErrorMessage="* Required" ControlToValidate="txtProjectMtceReasonSub"
                    ...
                    <div class="col-md-7">
                        <div class="box box-primary">
                            <div class="box-header">
                                <div class="col-md-6">
                                    <h3 class="box-title">Manage Mtce Reasons Sub</h3>
                                </div>
                            ...
                            <div class="box-body table-scrollable1">
                                <asp:Repeater ID="rptProjectMtceReasonSub" runat="server" OnItemCommand="rptProjectMtceReasonSub_ItemCommand">
                                    <HeaderTemplate>
                                        <table id="Table1" class="table table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    <th class="text-center">Active</th>
                                                    <th class="text-center">Mtce Reasons Sub</th>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lblProjectMtceReasonSub" runat="server" Text='<%#Eval("ProjectMtceReasonSub") %>'></asp:Label>
                                            </td>

                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkEdit" runat="server" ToolTip="Edit" CommandName="Edit"
                                                        CommandArgument='<%# Eval("ProjectMtceReasonSubID") %>'><i class="fa fa-edit"></i>
                                                    </asp:LinkButton>
                                                </span>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkDelete" runat="server" ToolTip="Delete" CommandName="Delete"
                                                        CommandArgument='<%# Eval("ProjectMtceReasonSubID") %>' OnClientClick="return confirm('Are you Want to Remove Mtce Reason Sub?')">
