<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MainMaster.Master" AutoEventWireup="true" CodeBehind="insuranceclaimstatus.aspx.cs" Inherits="SolarCRM.admin.masters.insuranceclaimstatus" %>
                    ...
                    <div class="col-md-5">
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">Insurance Claim Status</h3>
                            </div>
                            <div class="form-horizontal">
                                <div class="box-body">

                                    <div class="form-group formmargin">
                                        <label class="col-sm-3 control-label">Insurance Claim Status <span class="red">*</span></label>
                                        <div class="col-sm-9">
                                            <asp:HiddenField ID="hdnInsuranceClaimStatusID" runat="server" ClientIDMode="Static" />
                                            <asp:TextBox ID="txtInsuranceClaimStatus" ClientIDMode="Static" class="form-control" runat="server" placeholder="Insurance Claim Status"></asp:TextBox>
                                            <span>
                                                <asp:RequiredFieldValidator ID="rfvInsuranceClaimStatus" runat="server" ErrorMessage="* Required" ControlToValidate="txtInsuranceClaimStatus"
                    ...
                    <div class="col-md-7">
                        <div class="box box-primary">
                            <div class="box-header">
                                <div class="col-md-6">
                                    <h3 class="box-title">Manage Insurance Claim Status</h3>
                                </div>
                            ...
                            <div class="box-body table-scrollable1">
                                <asp:Repeater ID="rptInsuranceClaimStatus" runat="server" OnItemCommand="rptInsuranceClaimStatus_ItemCommand">
                                    <HeaderTemplate>
                                        <table id="Table1" class="table table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    <th class="text-center">Active</th>
                                                    <th class="text-center">Insurance Claim Status</th>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lblInsuranceClaimStatus" runat="server" Text='<%#Eval("InsuranceClaimStatus") %>'></asp:Label>
                                            </td>

                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkEdit" runat="server" ToolTip="Edit" CommandName="Edit"
                                                        CommandArgument='<%# Eval("InsuranceClaimStatusID") %>'><i class="fa fa-edit"></i>
                                                    </asp:LinkButton>
                                                </span>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkDelete" runat="server" ToolTip="Delete" CommandName="Delete"
                                                        CommandArgument='<%# Eval("InsuranceClaimStatusID") %>' OnClientClick="return confirm('Are you Want to Remove Insurance Claim Status?')">
