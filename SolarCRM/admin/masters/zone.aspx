<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MainMaster.Master" AutoEventWireup="true" CodeBehind="zone.aspx.cs" Inherits="SolarCRM.admin.masters.zone" %>
                            ...
                            <div class="form-horizontal">
                                <div class="box-body">
                                    ...
                                    <div class="form-group formmargin">
                                        <label class="col-sm-4 control-label">Zone <span class="red">*</span></label>
                                        <div class="col-sm-8">
                                            <asp:HiddenField ID="hdnZoneID" runat="server" ClientIDMode="Static" />
                                            <asp:TextBox ID="txtZone" ClientIDMode="Static" class="form-control" runat="server" placeholder="Zone"></asp:TextBox>
                                            <span>
                                                <asp:RequiredFieldValidator ID="rfvProjectType" runat="server" ErrorMessage="* Required" ControlToValidate="txtZone"
                    ...
                    <div class="col-md-7">
                        <div class="box box-primary">
                            <div class="box-header">
                                <div class="col-md-6">
                                    <h3 class="box-title">Manage Zone</h3>
                                </div>
                            ...
                            <div class="box-body table-scrollable1">
                                <asp:Repeater ID="rptZone" runat="server" OnItemCommand="rptZone_ItemCommand">
                                    <HeaderTemplate>
                                            ...
                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkEdit" runat="server" ToolTip="Edit" CommandName="Edit"
                                                        CommandArgument='<%# Eval("ZoneID") %>'><i class="fa fa-edit"></i>
                                                    </asp:LinkButton>
                                                </span>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkDelete" runat="server" ToolTip="Delete" CommandName="Delete"
                                                        CommandArgument='<%# Eval("ZoneID") %>' OnClientClick="return confirm('Are you Want to Remove Zone Type?')">
