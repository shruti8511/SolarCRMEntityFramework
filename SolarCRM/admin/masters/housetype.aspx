<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MainMaster.Master" AutoEventWireup="true" CodeBehind="housetype.aspx.cs" Inherits="SolarCRM.admin.masters.housetype" %>
                    ...
                    <div class="col-md-5">
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">House Type</h3>
                            </div>
                            <div class="form-horizontal">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">House Type <span class="red">*</span></label>
                                        <div class="col-sm-9">
                                            <asp:HiddenField ID="hdnHouseTypeID" runat="server" ClientIDMode="Static" />
                                            <asp:TextBox ID="txtHouseType" ClientIDMode="Static" class="form-control" runat="server" placeholder="House Type"></asp:TextBox>
                                            <span>
                                                <asp:RequiredFieldValidator ID="rfvHouseType" runat="server" ErrorMessage="* Required" ControlToValidate="txtHouseType"
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Variations <span class="red">*</span></label>
                                        <div class="col-sm-9">
                                            <asp:TextBox ID="txtVariations" ClientIDMode="Static" class="form-control" runat="server" placeholder="Variations"></asp:TextBox>
                                            <span>
                                                <asp:RequiredFieldValidator ID="rfvVariations" runat="server" ErrorMessage="* Required" ControlToValidate="txtVariations"
                                                    ValidationGroup="error"></asp:RequiredFieldValidator></span>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">House Type ABB <span class="red">*</span></label>
                                        <div class="col-sm-9">
                                            <asp:TextBox ID="txtHouseTypeABB" ClientIDMode="Static" class="form-control" runat="server" placeholder="House Type ABB"></asp:TextBox>
                                            <span>
                                                <asp:RequiredFieldValidator ID="rfvHouseTypeABB" runat="server" ErrorMessage="* Required" ControlToValidate="txtHouseTypeABB"
                                                    ValidationGroup="error"></asp:RequiredFieldValidator></span>
                                        </div>
                                    </div>
                    ...
                    <div class="col-md-7">
                        <div class="box box-primary">
                            <div class="box-header">
                                <div class="col-md-6">
                                    <h3 class="box-title">Manage House Type</h3>
                                </div>
                            ...
                            <div class="box-body table-scrollable1">
                                <asp:Repeater ID="rptHouseType" runat="server" OnItemCommand="rptHouseType_ItemCommand">
                                    <HeaderTemplate>
                                        <table id="Table1" class="table table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center">House TypeABB</th>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lblHouseType" runat="server" Text='<%#Eval("HouseType") %>'></asp:Label>
                                            </td>

                                             <td>
                                                <asp:Label ID="lblVariation" runat="server" Text='<%#Eval("Variation") %>'></asp:Label>
                                            </td>

                                             <td>
                                                <asp:Label ID="lblHouseTypeABB" runat="server" Text='<%#Eval("HouseTypeABB") %>'></asp:Label>
                                            </td>

                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkEdit" runat="server" ToolTip="Edit" CommandName="Edit"
                                                        CommandArgument='<%# Eval("HouseTypeID") %>'><i class="fa fa-edit"></i>
                                                    </asp:LinkButton>
                                                </span>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkDelete" runat="server" ToolTip="Delete" CommandName="Delete"
                                                        CommandArgument='<%# Eval("HouseTypeID") %>' OnClientClick="return confirm('Are you Want to Remove House Type?')">
