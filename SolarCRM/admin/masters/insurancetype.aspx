<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MainMaster.Master" AutoEventWireup="true" CodeBehind="insurancetype.aspx.cs" Inherits="SolarCRM.admin.masters.insurancetype" %>
                    ...
                    <div class="col-md-5">
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">Insurance Type</h3>
                            </div>
                            <div class="form-horizontal">
                                <div class="box-body">

                                    <div class="form-group formmargin">
                                        <label class="col-sm-3 control-label">Insurance Type<span class="red">*</span></label>
                                        <div class="col-sm-9">
                                            <asp:HiddenField ID="hdnInsuranceTypeID" runat="server" ClientIDMode="Static" />
                                            <asp:TextBox ID="txtInsuranceType" ClientIDMode="Static" class="form-control" runat="server" placeholder="Insurance Type"></asp:TextBox>
                                            <span>
                                                <asp:RequiredFieldValidator ID="rfvInsuranceType" runat="server" ErrorMessage="* Required" ControlToValidate="txtInsuranceType"
                    ...
                    <div class="col-md-7">
                        <div class="box box-primary">
                            <div class="box-header">
                                <div class="col-md-6">
                                    <h3 class="box-title">Manage Insurance Type</h3>
                                </div>
                            ...
                            <div class="box-body table-scrollable1">
                                <asp:Repeater ID="rptInsuranceType" runat="server" OnItemCommand="rptInsuranceType_ItemCommand">
                                    <HeaderTemplate>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lblInsuranceType" runat="server" Text='<%#Eval("InsuranceType") %>'></asp:Label>
                                            </td>

                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkEdit" runat="server" ToolTip="Edit" CommandName="Edit"
                                                        CommandArgument='<%# Eval("InsuranceTypeID") %>'><i class="fa fa-edit"></i>
                                                    </asp:LinkButton>
                                                </span>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkDelete" runat="server" ToolTip="Delete" CommandName="Delete"
                                                        CommandArgument='<%# Eval("InsuranceTypeID") %>' OnClientClick="return confirm('Are you Want to Remove Insurance Claim Status?')">
