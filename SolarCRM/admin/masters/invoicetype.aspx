<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MainMaster.Master" AutoEventWireup="true" CodeBehind="invoicetype.aspx.cs" Inherits="SolarCRM.admin.masters.invoicetype" %>
                    ...
                    <div class="col-md-5">
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">Invoice Type</h3>
                            </div>
                            <div class="form-horizontal">
                                <div class="box-body">

                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Invoice Type<span class="red">*</span></label>
                                        <div class="col-sm-9">
                                            <asp:HiddenField ID="hdnInvoiceTypeID" runat="server" ClientIDMode="Static" />
                                            <asp:TextBox ID="txtInvoiceType" ClientIDMode="Static" class="form-control" runat="server" placeholder="Invoice Type"></asp:TextBox>
                                            <span>
                                                <asp:RequiredFieldValidator ID="rfvInvoiceType" runat="server" ErrorMessage="* Required" ControlToValidate="txtInvoiceType"
                    ...
                    <div class="col-md-7">
                        <div class="box box-primary">
                            <div class="box-header">
                                <div class="col-md-6">
                                    <h3 class="box-title">Manage Invoice Type</h3>
                                </div>
                            ...
                            <div class="box-body table-scrollable1">
                                <asp:Repeater ID="rptInvoiceType" runat="server" OnItemCommand="rptInvoiceType_ItemCommand">
                                    <HeaderTemplate>
                                            ...
                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkEdit" runat="server" ToolTip="Edit" CommandName="Edit"
                                                        CommandArgument='<%# Eval("InvoiceTypeID") %>'><i class="fa fa-edit"></i>
                                                    </asp:LinkButton>
                                                </span>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkDelete" runat="server" ToolTip="Delete" CommandName="Delete"
                                                        CommandArgument='<%# Eval("InvoiceTypeID") %>' OnClientClick="return confirm('Are you Want to Remove Invoice Type?')">
