<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MainMaster.Master" AutoEventWireup="true" CodeBehind="billto.aspx.cs" Inherits="SolarCRM.admin.masters.billto" %>
                            ...
                            <div class="form-horizontal">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Bill To<span class="red">*</span></label>
                                        <div class="col-sm-9">
                                            <asp:HiddenField ID="hdnBillToID" runat="server" ClientIDMode="Static" />
                                            <asp:TextBox ID="txtBillTo" ClientIDMode="Static" class="form-control" runat="server" placeholder="Bill To"></asp:TextBox>
                                            <span>
                                                <asp:RequiredFieldValidator ID="rfvBillTo" runat="server" ErrorMessage="* Required" ControlToValidate="txtBillTo"
                    ...
                    <div class="col-md-7">
                        <div class="box box-primary">
                            <div class="box-header">
                                <div class="col-md-6">
                                    <h3 class="box-title">Manage Bill To</h3>
                                </div>
                            ...
                            <div class="box-body table-scrollable1">
                                <asp:Repeater ID="rptBillTo" runat="server" OnItemCommand="rptBillTo_ItemCommand">
                                    <HeaderTemplate>
                                            ...
                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkEdit" runat="server" ToolTip="Edit" CommandName="Edit"
                                                        CommandArgument='<%# Eval("BillToID") %>'><i class="fa fa-edit"></i>
                                                    </asp:LinkButton>
                                                </span>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkDelete" runat="server" ToolTip="Delete" CommandName="Delete"
                                                        CommandArgument='<%# Eval("BillToID") %>' OnClientClick="return confirm('Are you Want to Remove Bill To?')">
