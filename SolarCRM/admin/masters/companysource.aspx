<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MainMaster.Master" AutoEventWireup="true" CodeBehind="companysource.aspx.cs" Inherits="SolarCRM.admin.masters.leadsource" %>
    ...
    <section class="content-header">
       ...
       <%-- <small>Preview</small>--%>
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Company Source </li>
        </ol>
    </section>
                    ...
                    <div class="col-md-5">
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">Company Source</h3>
                            </div>
                            <div class="form-horizontal">
                                <div class="box-body">

                                    <div class="form-group formmargin">
                                        <label class="col-sm-3 control-label">Company Source <span class="red">*</span></label>
                                        <div class="col-sm-9">
                                            <asp:HiddenField ID="hdnCompanySourceID" runat="server" ClientIDMode="Static" />
                                            <asp:TextBox ID="txtCompanySource" ClientIDMode="Static" class="form-control" runat="server" placeholder="Company Source"></asp:TextBox>
                                            <span>
                                                <asp:RequiredFieldValidator ID="rfvProjectType" runat="server" ErrorMessage="* Required" ControlToValidate="txtCompanySource"
                    ...
                    <div class="col-md-7">
                        <div class="box box-primary">
                            <div class="box-header">
                                <div class="col-md-6">
                                    <h3 class="box-title">Manage Company Source</h3>
                                </div>
                            ...
                            <div class="box-body table-scrollable1">
                                <asp:Repeater ID="rptCompanySource" runat="server" OnItemCommand="rptCompanySource_ItemCommand">
                                    <HeaderTemplate>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lblCompanySource" runat="server" Text='<%#Eval("CompanySource") %>'></asp:Label>
                                            </td>
                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkEdit" runat="server" ToolTip="Edit" CommandName="Edit"
                                                        CommandArgument='<%# Eval("CompanySourceID") %>'><i class="fa fa-edit"></i>
                                                    </asp:LinkButton>
                                                </span>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkDelete" runat="server" ToolTip="Delete" CommandName="Delete"
                                                        CommandArgument='<%# Eval("CompanySourceID") %>' OnClientClick="return confirm('Are you Want to Remove Company Source?')">
