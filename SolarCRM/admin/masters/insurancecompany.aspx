<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MainMaster.Master" AutoEventWireup="true" CodeBehind="insurancecompany.aspx.cs" Inherits="SolarCRM.admin.masters.insurancecompany" %>
                            ...
                            <div class="form-horizontal">
                                <div class="box-body">
                                    ...
                                    <div class="form-group formmargin">
                                        <label class="col-sm-3 control-label">Insurance Company <span class="red">*</span></label>
                                        <div class="col-sm-9">
                                            <asp:HiddenField ID="hdnInsuranceCompanyID" runat="server" ClientIDMode="Static" />
                                            <asp:TextBox ID="txtInsuranceCompany" ClientIDMode="Static" class="form-control" runat="server" placeholder="Insurance Company"></asp:TextBox>
                                            <span>
                                                <asp:RequiredFieldValidator ID="rfvInsuranceCompany" runat="server" ErrorMessage="* Required" ControlToValidate="txtInsuranceCompany"
                    ...
                    <div class="col-md-7">
                        <div class="box box-primary">
                            <div class="box-header">
                                <div class="col-md-6">
                                    <h3 class="box-title">Manage Insurance Company</h3>
                                </div>
                            ...
                            <div class="box-body table-scrollable1">
                                <asp:Repeater ID="rptInsuranceCompany" runat="server" OnItemCommand="rptInsuranceCompany_ItemCommand">
                                    <HeaderTemplate>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lblProjectType" runat="server" Text='<%#Eval("InsuranceCompany") %>'></asp:Label>
                                            </td>

                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkEdit" runat="server" ToolTip="Edit" CommandName="Edit"
                                                        CommandArgument='<%# Eval("InsuranceCompanyID") %>'><i class="fa fa-edit"></i>
                                                    </asp:LinkButton>
                                                </span>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkDelete" runat="server" ToolTip="Delete" CommandName="Delete"
                                                        CommandArgument='<%# Eval("InsuranceCompanyID") %>' OnClientClick="return confirm('Are you Want to Remove Insurance Company?')">
