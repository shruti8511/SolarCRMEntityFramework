<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MainMaster.Master" AutoEventWireup="true" CodeBehind="mtcecompanytype.aspx.cs" Inherits="SolarCRM.admin.masters.mtcecompanytype" %>
                    ...
                    <div class="col-md-5">
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">Mtce Company Type</h3>
                            </div>
                            <div class="form-horizontal">
                                <div class="box-body">
                                    ...
                                    <div class="form-group formmargin">
                                        <label class="col-sm-3 control-label">Company Name <span class="red">*</span></label>
                                        <div class="col-sm-9">
                                            <asp:HiddenField ID="hdnMtceCompanyTypeID" runat="server" ClientIDMode="Static" />
                                            <asp:TextBox ID="txtMtceCompanyType" ClientIDMode="Static" class="form-control" runat="server" placeholder="Company Name"></asp:TextBox>
                                            <span>
                                                <asp:RequiredFieldValidator ID="rfvMtceCompanyType" runat="server" ErrorMessage="* Required" ControlToValidate="txtMtceCompanyType"
                    ...
                    <div class="col-md-7">
                        <div class="box box-primary">
                            <div class="box-header">
                                <div class="col-md-6">
                                    <h3 class="box-title">Manage Mtce Company Type</h3>
                                </div>
                            ...
                            <div class="box-body table-scrollable1">
                                <asp:Repeater ID="rptMtceCompanyType" runat="server" OnItemCommand="rptMtceCompanyType_ItemCommand">
                                    <HeaderTemplate>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lblMtceCompanyType" runat="server" Text='<%#Eval("MtceCompanyType") %>'></asp:Label>
                                            </td>

                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkEdit" runat="server" ToolTip="Edit" CommandName="Edit"
                                                        CommandArgument='<%# Eval("MtceCompanyTypeID") %>'><i class="fa fa-edit"></i>
                                                    </asp:LinkButton>
                                                </span>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkDelete" runat="server" ToolTip="Delete" CommandName="Delete"
                                                        CommandArgument='<%# Eval("MtceCompanyTypeID") %>' OnClientClick="return confirm('Are you Want to Remove Company Type?')">
