<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MainMaster.Master" AutoEventWireup="true" CodeBehind="specialpurpose.aspx.cs" Inherits="SolarCRM.admin.masters.specialpurpose" %>
    ...
    <section class="content-header">
       ...
       <%-- <small>Preview</small>--%>
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Special Purpose </li>
        </ol>
    </section>
                    ...
                    <div class="col-md-5">
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">Special Purpose</h3>
                            </div>
                            <div class="form-horizontal">
                                <div class="box-body">

                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Special Purpose<span class="red">*</span></label>
                                        <div class="col-sm-9">
                                            <asp:HiddenField ID="hdnSpecialPurposeID" runat="server" ClientIDMode="Static" />
                                            <asp:TextBox ID="txtSpecialPurpose" ClientIDMode="Static" class="form-control" runat="server" placeholder="Special Purpose"></asp:TextBox>
                                            <span>
                                                <asp:RequiredFieldValidator ID="rfvSpecialPurpose" runat="server" ErrorMessage="* Required" ControlToValidate="txtSpecialPurpose"
                    ...
                    <div class="col-md-7">
                        <div class="box box-primary">
                            <div class="box-header">
                                <div class="col-md-6">
                                    <h3 class="box-title">Manage Special Purpose</h3>
                                </div>
                            ...
                            <div class="box-body table-scrollable1">
                                <asp:Repeater ID="rptSpecialPurpose" runat="server" OnItemCommand="rptSpecialPurpose_ItemCommand">
                                    <HeaderTemplate>
                                        <table id="Table1" class="table table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    <th class="text-center">Active</th>
                                                    <th class="text-center">Special Purpose</th>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lblSpecialPurpose" runat="server" Text='<%#Eval("SpecialPurpose") %>'></asp:Label>
                                            </td>

                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkEdit" runat="server" ToolTip="Edit" CommandName="Edit"
                                                        CommandArgument='<%# Eval("SpecialPurposeID") %>'><i class="fa fa-edit"></i>
                                                    </asp:LinkButton>
                                                </span>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkDelete" runat="server" ToolTip="Delete" CommandName="Delete"
                                                        CommandArgument='<%# Eval("SpecialPurposeID") %>' OnClientClick="return confirm('Are you Want to Remove Special Purpose?')">
