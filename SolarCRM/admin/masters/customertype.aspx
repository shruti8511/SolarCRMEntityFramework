<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MainMaster.Master" AutoEventWireup="true" CodeBehind="customertype.aspx.cs" Inherits="SolarCRM.admin.masters.customertype" %>
                            ...
                            <div class="form-horizontal">
                                <div class="box-body">
                                    ...
                                    <div class="form-group formmargin">
                                        <label class="col-sm-4 control-label">Customer Type <span class="red">*</span></label>
                                        <div class="col-sm-8">
                                            <asp:HiddenField ID="hdnCustTypeID" runat="server" ClientIDMode="Static" />
                                            <asp:TextBox ID="txtCustomerType" ClientIDMode="Static" class="form-control" runat="server" placeholder="Customer Type"></asp:TextBox>

                                            <span>
                                                <asp:RequiredFieldValidator ID="rfvcollegename" runat="server" ErrorMessage="* Required" ControlToValidate="txtCustomerType"
                    ...
                    <div class="col-md-7">
                        <div class="box box-primary">
                            <div class="box-header">
                                <div class="col-md-6">
                                    <h3 class="box-title">Manage Customer Type</h3>
                                </div>
                            ...
                            <div class="box-body table-scrollable1">
                                <asp:Repeater ID="rptCustomerType" runat="server" OnItemCommand="rptCustomerType_ItemCommand">
                                    <HeaderTemplate>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lblCustType" runat="server" Text='<%#Eval("CustType") %>'></asp:Label>
                                            </td>
                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkEdit" runat="server" ToolTip="Edit" CommandName="Edit"
                                                        CommandArgument='<%# Eval("CustTypeID") %>'><i class="fa fa-edit"></i>
                                                    </asp:LinkButton>
                                            ...
                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkDelete" runat="server" ToolTip="Delete" CommandName="Delete"
                                                        CommandArgument='<%# Eval("CustTypeID") %>' OnClientClick="return confirm('Are you Want to Remove Customer Type?')">
