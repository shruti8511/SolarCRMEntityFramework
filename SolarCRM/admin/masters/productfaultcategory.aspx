<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MainMaster.Master" AutoEventWireup="true" CodeBehind="productfaultcategory.aspx.cs" Inherits="SolarCRM.admin.masters.productfaultcategory" %>
                    ...
                    <div class="col-md-5">
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">Product Fault Category</h3>
                            </div>
                            <div class="form-horizontal">
                                <div class="box-body">
                                    ...
                                    <div class="form-group formmargin">
                                        ...
                                        <div class="col-sm-9">
                                            <asp:HiddenField ID="hdnProductFaultCategoryID" runat="server" ClientIDMode="Static" />
                                            <asp:TextBox ID="txtProductFaultCategory" ClientIDMode="Static" class="form-control" runat="server" placeholder="Category"></asp:TextBox>
                                            <span>
                                                <asp:RequiredFieldValidator ID="rfvProductFaultCategory" runat="server" ErrorMessage="* Required" ControlToValidate="txtProductFaultCategory"
                    ...
                    <div class="col-md-7">
                        <div class="box box-primary">
                            <div class="box-header">
                                <div class="col-md-6">
                                    <h3 class="box-title">Manage Product Fault Category</h3>
                                </div>
                            ...
                            <div class="box-body table-scrollable1">
                                <asp:Repeater ID="rptProductFaultCategory" runat="server" OnItemCommand="rptProductFaultCategory_ItemCommand">
                                    <HeaderTemplate>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lblProjectMtceReasonSub" runat="server" Text='<%#Eval("ProductFaultCategory") %>'></asp:Label>
                                            </td>

                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkEdit" runat="server" ToolTip="Edit" CommandName="Edit"
                                                        CommandArgument='<%# Eval("ProductFaultCategoryID") %>'><i class="fa fa-edit"></i>
                                                    </asp:LinkButton>
                                                </span>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <span>
                                                    <asp:LinkButton ID="lnkDelete" runat="server" ToolTip="Delete" CommandName="Delete"
                                                        CommandArgument='<%# Eval("ProductFaultCategoryID") %>' OnClientClick="return confirm('Are you Want to Remove Category?')">
